...
describe('chapter words', function() {
    it('is correct', function() {
        books.forEach(function(book, index) {
            book.chapters.forEach(function(chapter) {
                let actual   = 0
...
describe('book letters', function() {
    it('is correct', function() {
        books.forEach(function(book, index) {
            let actual   = 0
            let expected = 0
...
describe('book total value', function() {
    it('is correct', function() {
        books.forEach(function(book, index) {
            let actual   = 0
            let expected = 0
...
describe('cumulative book letters', function() {
    it('is correct', function() {
        let actual   = 0
        let expected = 0
            ...
            book.chapters.forEach(function(chapter) {
                chapter.verses.forEach(function(verse) {
                    verse.words.forEach(function(word) {
                        ...
                        actual    = word.cumulative_book_letters
                        expected += word.letters
                    })
                })
            })
...
describe('cumulative book words', function() {
    it('is correct', function() {
        let actual   = 0
        let expected = 0
            ...
            book.chapters.forEach(function(chapter) {
                chapter.verses.forEach(function(verse) {
                    verse.words.forEach(function(word) {
                        ...
                        actual = word.cumulative_book_words
                        expected++
                    })
                })
            })
